...
const Navbar = () => {
  ...
  return (
    <header className="text-gray-600 body-font bg-white fixed top-0 left-0 right-0 z-50 h-20">
      <div className="container mx-auto flex flex-wrap lg:p-5 p-3 items-center justify-between h-full">
        ...
        <div className="hidden md:flex items-center gap-x-4 md:ml-auto">
          ...
          <div className="language-dropdown flex items-center gap-x-2 border px-3 py-1 rounded hover:custom-border-color cursor-pointer">
            ...
            <select
              ...
              className="p-1 font-bold hover:outline-none"
            >
        ...
        <div className="flex items-center ml-3">
          <span>
            <GiShoppingCart
              ...
              className="text-custom-button-color"
            />
          </span>
        </div>
      </div>
