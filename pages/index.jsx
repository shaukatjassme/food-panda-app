    ...
    <>
      ...
      >
        ...
        <div className="left-side flex flex-col justify-center items-start p-8 lg:w-1/2 space-y-6">
          ...
          {/* Search bar with icon and Find button container */}
          <div className="flex items-center bg-white p-2 rounded-md shadow-md w-full"> {/* Added a wrapper div with background */}
            <div className="relative w-full">
              <input
                type="text"
                placeholder="Enter street number"
                className="pl-1 pr-16 py-3 w-full border rounded-lg focus:outline-none" // Adjusted padding-right
              />
              <a href="#">
                {/* Locate Me icon positioned before the text */}
                <FaMapMarkedAlt className="absolute right-24 top-1/2 text-locate-me-btn transform -translate-y-1/2 " />

                {/* Text next to the Locate Me icon */}
                <span className="absolute right-2 top-1/2 transform -translate-y-1/2 text-gray-600">Locate me</span>
              </a>
            </div>


            {/* Find button */}
            <button className="signup-btn text-white py-3 px-6 rounded-md ml-2 whitespace-nowrap">
  Find Food
</button>
